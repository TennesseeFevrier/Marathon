    ...
    <div class="box-body">
        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label" for="name"><?= __d('users', 'Name'); ?> <font color='#00CC00'>*</font></label>
                <div class="col-sm-8">
                    <input name="name" id="name" type="text" class="form-control" value="<?= Input::old('name', $role->name); ?>" placeholder="<?= __d('users', 'Name'); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="slug"><?= __d('users', 'Slug'); ?> <font color='#00CC00'>*</font></label>
                <div class="col-sm-8">
                    <input name="slug" id="slug" type="text" class="form-control" value="<?= Input::old('slug', $role->slug); ?>" placeholder="<?= __d('users', 'Slug'); ?>">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="description"><?= __d('users', 'Description'); ?> <font color='#00CC00'>*</font></label>
                <div class="col-sm-8">
            ...
            <div class="clearfix"></div>
            <br>
            <font color='#00CC00'>*</font><?= __d('users', 'Required field'); ?>
            <hr>
            <div class="form-group">
                <div class="col-sm-12">
